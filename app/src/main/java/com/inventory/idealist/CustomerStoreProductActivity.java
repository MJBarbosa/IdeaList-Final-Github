...
public class CustomerStoreProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadAndDisplayStoreTimes(userUid);
    }

    private void loadAndDisplayStoreTimes(String userUid) {
    ...
    private void displayStoreTimes(String openTime, String closeTime) {
        if (!openTime.isEmpty() && !closeTime.isEmpty()) {
            ...
            TextView timesDisplay = findViewById(R.id.textViewCusShowStoreTime);
        ...
        public class ProductViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bind(PointOfSaleActivity.Product product) {
                ...
                if (Integer.parseInt(product.getQuantity()) == 0) {
                    quantity.setText("Not Available");
